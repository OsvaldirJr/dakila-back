...
export interface ApiAppRoleAppRole extends Schema.CollectionType {
...
export interface ApiCoreCore extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::core.core', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::core.core', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiUserDataUserData extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    gender: Attribute.Enumeration<['masc', 'fem', 'other']>;
    cellphone: Attribute.BigInteger;
    rg: Attribute.BigInteger;
    cpf: Attribute.BigInteger;
    frequency: Attribute.Boolean;
    address: Attribute.String;
    symbol: Attribute.Boolean;
    district: Attribute.String;
    city: Attribute.String;
    state: Attribute.String;
    zip_code: Attribute.String;
    addressNumber: Attribute.BigInteger;
